...
/**
 * Sign-in for the build with no backend: the app is an in-browser demo, the
 * "session" lives in localStorage, and the form says so.
 */
export function DemoLogin({ next, role: initialRole }: { next: string | null; role: Role }) {
