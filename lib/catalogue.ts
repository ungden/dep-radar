...
export const catalogueSections: CatalogueSection[] = [
  {
    ...
    filters: ["Da dầu mụn", "Da khô căng", "Da nhạy cảm", "Da đang treatment", "Sau sinh/mang thai"],
    productTypes: ["Sữa rửa mặt dịu nhẹ", "Serum phục hồi", "Kem dưỡng khóa ẩm", "Kem chống nắng hằng ngày", "Treatment trị mụn", "Hoạt chất sáng da"],
    featuredQueries: ["routine skincare người mới", "routine da dầu mụn", "da treatment phục hồi", "kem chống nắng không bí"],
    topMenu: true,
    branches: [
      {
        title: "Mới bắt đầu skincare",
        description: "Chưa rõ loại da, đang muốn dựng routine sáng/tối ít bước trước khi mua treatment.",
        audience: "Da chưa có vấn đề nặng hoặc bạn đang rối vì quá nhiều sản phẩm.",
        nextStep: "Chốt 3 bước nền: làm sạch dịu, dưỡng vừa đủ, chống nắng ban ngày; dùng ổn 2-4 tuần rồi mới thêm hoạt chất.",
        articleTitle: "Hướng dẫn nền skincare cho người mới",
        productTypes: ["Sữa rửa mặt dịu nhẹ", "Kem dưỡng", "Kem chống nắng hằng ngày"],
        keywords: ["routine người mới", "skincare cơ bản", "routine 3 bước"],
      },
      {
        title: "Da dầu mụn, dễ bí tắc",
        description: "Có mụn ẩn, mụn viêm nhẹ, da bóng dầu hoặc dễ bí khi đổi kem chống nắng/kem dưỡng.",
        audience: "Phù hợp khi mục tiêu là giảm bít tắc nhưng vẫn giữ hàng rào da ổn.",
        nextStep: "Giữ cleanser dịu và kem chống nắng ráo; chỉ chọn một treatment chính như BHA, azelaic acid hoặc retinoid tần suất thấp.",
        articleTitle: "Routine da dầu mụn 4 bước",
        productTypes: ["Sữa rửa mặt dịu nhẹ", "Treatment trị mụn", "Kem chống nắng hằng ngày"],
        keywords: ["routine da dầu mụn", "mụn ẩn", "BHA"],
      },
      {
        title: "Da yếu sau treatment",
        description: "Da rát, bong quanh mũi/miệng, châm chích hoặc nổi li ti sau acid, retinoid, peel tại nhà.",
        audience: "Ưu tiên cho người đang treatment quá tay hoặc vừa đổi nhiều sản phẩm.",
        nextStep: "Tạm dừng hoạt chất mạnh, quay về làm sạch dịu - dưỡng phục hồi - chống nắng; theo dõi rát đỏ trước khi dùng lại treatment.",
        articleTitle: "Da treatment bị yếu nên phục hồi ra sao",
        productTypes: ["Serum phục hồi", "Kem dưỡng khóa ẩm", "Kem chống nắng hằng ngày"],
        keywords: ["da treatment", "phục hồi barrier", "B5 ceramide"],
      },
      {
        title: "Chống nắng hằng ngày",
        description: "Cần kem chống nắng không bí, không vón, dễ thoa lại khi đi làm hoặc ở khí hậu nóng ẩm.",
        audience: "Nền bắt buộc nếu bạn đang trị mụn, làm sáng, dùng retinoid hoặc dễ thâm sau viêm.",
        nextStep: "Chọn texture dùng đủ lượng được mỗi ngày trước khi tối ưu SPF cao, finish đẹp hay chống nước.",
        articleTitle: "Kem chống nắng không bí cho khí hậu nóng ẩm",
        productTypes: ["Kem chống nắng hằng ngày", "Sữa rửa mặt dịu nhẹ"],
        keywords: ["kem chống nắng không bí", "chống nắng da dầu", "thoa lại"],
      },
      {
        title: "Thâm mụn, da xỉn màu",
        description: "Vết thâm sau mụn, da không đều màu, xỉn khi thiếu ngủ hoặc chống nắng chưa đều.",
        audience: "Hợp khi mụn mới đã được kiểm soát tương đối; nếu mụn còn bùng, xử lý mụn trước.",
        nextStep: "Ổn định chống nắng rồi mới thêm vitamin C, niacinamide hoặc tranexamic acid; đo tiến triển theo tháng.",
        articleTitle: "Thâm mụn bao lâu mờ",
        productTypes: ["Kem chống nắng hằng ngày", "Hoạt chất sáng da", "Serum phục hồi"],
        keywords: ["thâm mụn", "đều màu", "vitamin C"],
      },
      {
        title: "Da khô căng, thiếu ẩm",
        description: "Da căng sau rửa mặt, bong nhẹ, nền makeup mốc hoặc cảm giác thiếu nước dù vẫn đổ dầu.",
        audience: "Dành cho người cần phân biệt thiếu nước, thiếu dầu và hàng rào da yếu.",
        nextStep: "Đổi sang làm sạch dịu hơn, thêm humectant và kem dưỡng đủ khóa ẩm; tránh tẩy da chết khi da đang bong rát.",
        articleTitle: "Da khô thiếu nước khác da thiếu dầu ra sao",
        productTypes: ["Sữa rửa mặt dịu nhẹ", "Serum phục hồi", "Kem dưỡng khóa ẩm"],
        keywords: ["da khô thiếu nước", "cấp ẩm", "ceramide"],
      },
      {
        title: "Da nhạy cảm, dễ đỏ rát",
        description: "Da đỏ, châm chích, dễ phản ứng với hương liệu hoặc đổi sản phẩm là nổi mẩn.",
        audience: "Nên đi theo hướng giảm biến số, không mua thêm nhiều hoạt chất cùng lúc.",
        nextStep: "Giữ routine tối giản, patch test, ưu tiên công thức ít hương liệu; nếu đỏ đau kéo dài thì dừng tự xử lý.",
        articleTitle: "Da nhạy cảm nên xây routine như thế nào",
        productTypes: ["Sữa rửa mặt dịu nhẹ", "Serum phục hồi", "Kem dưỡng khóa ẩm"],
        keywords: ["da nhạy cảm", "kích ứng", "patch test"],
      },
      {
        title: "Muốn thêm retinol hoặc acid",
        description: "Đang cân nhắc retinol, AHA/BHA/PHA nhưng chưa biết chọn loại nào và dùng tần suất ra sao.",
        audience: "Chỉ nên bắt đầu khi routine nền đã ổn và da không còn rát đỏ.",
        nextStep: "Chọn một hoạt chất, dùng thấp - chậm - thưa; tách lịch với acid khác nếu da chưa quen.",
        articleTitle: "Retinol cho người mới",
        productTypes: ["Treatment trị mụn", "Serum phục hồi", "Kem chống nắng hằng ngày"],
        keywords: ["retinol người mới", "AHA BHA PHA", "tần suất treatment"],
      },
      {
        title: "Nám, sắc tố hoặc sau sinh",
        description: "Nám mảng, tàn nhang, tăng sắc tố sau viêm hoặc lo treatment khi mang thai/sau sinh.",
        audience: "Cần thận trọng hơn vì không phải hoạt chất nào cũng phù hợp, đặc biệt khi mang thai hoặc cho con bú.",
        nextStep: "Bắt đầu bằng chống nắng và phục hồi; hỏi chuyên gia trước khi dùng hoạt chất mạnh hoặc làm clinic.",
        articleTitle: "Nám sau sinh nên chăm tại nhà hay đi clinic",
        productTypes: ["Kem chống nắng hằng ngày", "Hoạt chất sáng da", "Kem dưỡng khóa ẩm"],
        keywords: ["nám sau sinh", "sắc tố", "pregnancy-safe"],
      },
    ],
  },
  {
  ...
  },
  {
    ...
    description: "Chăm tóc và da đầu theo vấn đề: rụng tóc, gàu, da đầu dầu, tóc hư tổn, tạo kiểu và chăm râu.",
