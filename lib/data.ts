...
export const PROS: Pro[] = [
  {
    ...
    verifications: { phone: "verified", identity: "verified", skill: "verified", hygiene: "verified" },
    stats: { completedJobs: 486, cancellationRate: 0.024, responseRate: 0.97, responseMinutes: 10, onTimeRate: 0.96, repeatRate: 0.42 },
    rating: { average: 4.86, count: 312, skill: 4.91, punctuality: 4.78, hygiene: 4.95, attitude: 4.84 },
  },
  {
    id: "thu-anh",
    name: "Thu Anh",
    ...
    verifications: { phone: "verified", identity: "verified", skill: "verified", hygiene: "none" },
    stats: { completedJobs: 352, cancellationRate: 0.03, responseRate: 0.93, responseMinutes: 30, onTimeRate: 0.94, repeatRate: 0.35 },
    rating: { average: 4.81, count: 241, skill: 4.88, punctuality: 4.7, hygiene: 4.8, attitude: 4.86 },
  },
  {
    id: "mai-tran",
    name: "Mai Trần",
    ...
    verifications: { phone: "verified", identity: "verified", skill: "verified", hygiene: "verified" },
    stats: { completedJobs: 268, cancellationRate: 0.012, responseRate: 0.96, responseMinutes: 45, onTimeRate: 0.97, repeatRate: 0.51 },
    rating: { average: 4.9, count: 188, skill: 4.93, punctuality: 4.88, hygiene: 4.96, attitude: 4.9 },
  },
  {
    id: "quynh-vu",
    name: "Quỳnh Vũ",
    ...
    verifications: { phone: "verified", identity: "verified", skill: "pending", hygiene: "none" },
    stats: { completedJobs: 190, cancellationRate: 0.045, responseRate: 0.88, responseMinutes: 60, onTimeRate: 0.9, repeatRate: 0.28 },
    rating: { average: 4.7, count: 96, skill: 4.78, punctuality: 4.55, hygiene: 4.7, attitude: 4.75 },
  },
  {
    id: "ha-my",
    name: "Hà My",
    ...
    verifications: { phone: "verified", identity: "verified", skill: "verified", hygiene: "verified" },
    stats: { completedJobs: 410, cancellationRate: 0.018, responseRate: 0.98, responseMinutes: 15, onTimeRate: 0.95, repeatRate: 0.55 },
    rating: { average: 4.83, count: 276, skill: 4.87, punctuality: 4.8, hygiene: 4.9, attitude: 4.78 },
  },
  {
    id: "ngoc-bao",
    name: "Ngọc Bảo",
    ...
    verifications: { phone: "verified", identity: "pending", skill: "none", hygiene: "none" },
    stats: { completedJobs: 7, cancellationRate: 0, responseRate: 0.85, responseMinutes: 90, onTimeRate: 1, repeatRate: 0.14 },
    rating: { average: 4.8, count: 5, skill: 4.8, punctuality: 5, hygiene: 4.6, attitude: 4.8 },
  },
  {
    id: "dieu-huong",
    name: "Diệu Hương",
    ...
    highlights: ["Mang giường massage gấp", "Chứng chỉ massage bầu", "Khăn dùng riêng từng khách"],
    verifications: { phone: "verified", identity: "verified", skill: "verified", hygiene: "none" },
    stats: { completedJobs: 128, cancellationRate: 0.03, responseRate: 0.92, responseMinutes: 25, onTimeRate: 0.93, repeatRate: 0.47 },
    rating: { average: 4.78, count: 84, skill: 4.85, punctuality: 4.7, hygiene: 4.72, attitude: 4.82 },
  },
]
...
export const REVIEWS: Review[] = [
  r("r1", "linh-pham", "Ngọc Hân", 5, [5, 5, 5, 5], ["Tay nghề tốt", "Bền đẹp"], "Làm kỹ, form móng đẹp, đến đúng giờ. Giữ được hơn 3 tuần không bong.", "2026-09-02", "Nail thiết kế · Đính đá / charm", { photo: img("nail-milky-1"), reply: "Cảm ơn Hân nhiều, hẹn gặp lại lần sau nha!" }),
  r("r2", "linh-pham", "Thảo Vy", 5, [5, 4, 5, 5], ["Dụng cụ sạch sẽ", "Tư vấn kỹ"], "Tư vấn màu rất có tâm, dụng cụ hấp tiệt trùng trước mặt mình luôn.", "2026-08-21", "Sơn gel trơn · Tay"),
  r("r3", "linh-pham", "Minh Châu", 4, [5, 3, 5, 4], ["Tay nghề tốt"], "Đẹp, nhưng đến trễ 15 phút vì kẹt xe, có nhắn báo trước.", "2026-08-10", "Nối móng · Đắp gel", { reply: "Xin lỗi Châu vì hôm đó mưa kẹt xe, lần sau mình sẽ đi sớm hơn ạ." }),
  r("r4", "thu-anh", "Lan Phương", 5, [5, 5, 5, 5], ["Bền đẹp", "Nhẹ nhàng"], "Makeup trong veo, chụp ảnh lên rất xinh, bền cả tối.", "2026-09-05", "Makeup dự tiệc · Makeup", { photo: img("makeup-party-1") }),
  r("r5", "thu-anh", "Bảo Ngọc", 5, [5, 5, 4, 5], ["Tư vấn kỹ"], "Chị rất nhẹ nhàng, hỏi kỹ về da trước khi làm.", "2026-08-28", "Makeup chụp ảnh / kỷ yếu · 1 người"),
  r("r6", "thu-anh", "Hải Yến", 4, [5, 4, 4, 5], ["Tay nghề tốt"], "Layout đẹp, hơi lâu hơn dự kiến một chút.", "2026-08-12", "Makeup cô dâu · 1 lễ (ăn hỏi hoặc cưới)"),
  r("r7", "mai-tran", "Khánh Linh", 5, [5, 5, 5, 5], ["Dụng cụ sạch sẽ", "Nhẹ nhàng"], "Da dịu hẳn sau 2 buổi, không bị đỏ như lúc đi spa.", "2026-09-01", "Phục hồi da nhạy cảm · 75 phút", { photo: img("skin-glow"), reply: "Nhớ bôi kem chống nắng đều nha Linh!" }),
  r("r8", "mai-tran", "Tuấn Anh", 5, [5, 5, 5, 4], ["Tay nghề tốt", "Đúng giờ"], "Lấy mụn nhẹ tay, không thâm, dụng cụ bóc tem trước mặt.", "2026-08-19", "Lấy nhân mụn chuẩn y khoa · 60 phút"),
  r("r9", "quynh-vu", "Hồng Nhung", 5, [5, 4, 5, 5], ["Bền đẹp"], "Tóc giữ nếp tới cuối tiệc cưới.", "2026-08-17", "Tạo kiểu tóc sự kiện · Búi / tết cầu kỳ", { photo: img("hair-bun-1") }),
  r("r10", "quynh-vu", "Mỹ Duyên", 4, [4, 4, 5, 4], ["Giá hợp lý"], "Uốn đẹp nhưng lọn hơi nhanh xẹp.", "2026-08-02", "Tạo kiểu tóc sự kiện · Uốn / duỗi tạo kiểu"),
  r("r11", "ha-my", "Phương Anh", 5, [5, 5, 5, 5], ["Nhẹ nhàng", "Bền đẹp"], "Mi tự nhiên, không cộm, không cay mắt.", "2026-09-08", "Nối mi classic · Full set", { photo: img("lash-1") }),
  r("r12", "ha-my", "Thu Hà", 5, [5, 5, 5, 4], ["Đúng giờ"], "Dáng mày hợp mặt, làm nhanh.", "2026-08-25", "Tạo dáng & tỉa mày · Tạo dáng"),
  r("r13", "ngoc-bao", "Diệu Linh", 5, [5, 5, 4, 5], ["Giá hợp lý", "Nhẹ nhàng"], "Nhóm mình 3 người làm nhanh gọn, bạn rất dễ thương.", "2026-08-30", "Makeup dự tiệc · Makeup"),
  r("r14", "dieu-huong", "Quốc Bảo", 5, [5, 5, 4, 5], ["Tay nghề tốt", "Đúng giờ"], "Bấm huyệt đúng chỗ đau, mang theo cả giường gấp, rất chuyên nghiệp.", "2026-09-06", "Massage cổ vai gáy · 90 phút"),
  r("r15", "dieu-huong", "Thanh Tâm", 5, [5, 5, 5, 5], ["Nhẹ nhàng", "Tư vấn kỹ"], "Massage bầu tháng thứ 7, chị rất cẩn thận, hỏi kỹ tình trạng trước.", "2026-08-22", "Massage bầu · 60 phút", { reply: "Chúc mẹ bầu mẹ tròn con vuông nha!" }),
]
