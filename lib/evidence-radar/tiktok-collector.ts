...
export const TIKTOK_COLLECTOR_SCHEMA = "360dep.tiktok-manifest.v1"
...
export function normalizeTikTokCollectorBatch(
  ...
  if (body.schema_version !== TIKTOK_COLLECTOR_SCHEMA) throw new Error("Unsupported collector schema")
