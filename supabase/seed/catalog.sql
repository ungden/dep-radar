...
insert into public.service_variants (template_id, id, label, duration_min, min_price, max_price, suggested_price, per_person, max_quantity, sort_order) values (
  ...
  on conflict (template_id, id) do update set label = excluded.label, duration_min = excluded.duration_min,
    ...
    per_person = excluded.per_person, max_quantity = excluded.max_quantity, sort_order = excluded.sort_order;
insert into public.service_templates (id, category, name, description, includes, studio_only, active, sort_order) values (
  'photo-phone', 'photophone', 'Chụp ảnh bằng điện thoại', 'Chụp dạo, đi cafe, hẹn hò, sinh nhật bằng điện thoại đời mới. Có hướng dẫn tạo dáng.', array['Hướng dẫn tạo dáng', 'Toàn bộ ảnh gốc', 'Ảnh chỉnh màu theo gói']::text[], false, true, 32)
  on conflict (id) do update set category = excluded.category, name = excluded.name,
    description = excluded.description, includes = excluded.includes,
    studio_only = excluded.studio_only, active = excluded.active, sort_order = excluded.sort_order;
insert into public.service_variants (template_id, id, label, duration_min, min_price, max_price, suggested_price, per_person, max_quantity, sort_order) values (
...
insert into public.service_variants (template_id, id, label, duration_min, min_price, max_price, suggested_price, per_person, max_quantity, sort_order) values (
  ...
  on conflict (template_id, id) do update set label = excluded.label, duration_min = excluded.duration_min,
    ...
    per_person = excluded.per_person, max_quantity = excluded.max_quantity, sort_order = excluded.sort_order;
insert into public.service_templates (id, category, name, description, includes, studio_only, active, sort_order) values (
  'photo-phone-group', 'photophone', 'Chụp đôi / nhóm bạn', 'Chụp cặp đôi, nhóm bạn, gia đình nhỏ bằng điện thoại.', array['Hướng dẫn tạo dáng theo nhóm', 'Toàn bộ ảnh gốc', 'Ảnh chỉnh màu theo gói']::text[], false, true, 33)
  on conflict (id) do update set category = excluded.category, name = excluded.name,
    description = excluded.description, includes = excluded.includes,
    studio_only = excluded.studio_only, active = excluded.active, sort_order = excluded.sort_order;
insert into public.service_variants (template_id, id, label, duration_min, min_price, max_price, suggested_price, per_person, max_quantity, sort_order) values (
...
insert into public.service_variants (template_id, id, label, duration_min, min_price, max_price, suggested_price, per_person, max_quantity, sort_order) values (
  ...
  on conflict (template_id, id) do update set label = excluded.label, duration_min = excluded.duration_min,
    ...
    per_person = excluded.per_person, max_quantity = excluded.max_quantity, sort_order = excluded.sort_order;
insert into public.service_templates (id, category, name, description, includes, studio_only, active, sort_order) values (
  'photo-tour', 'photophone', 'Photo tour du lịch', 'Đi cùng bạn một buổi ở điểm du lịch, chụp suốt hành trình.', array['Lên lịch trình điểm chụp', 'Toàn bộ ảnh gốc', 'Ảnh chỉnh màu']::text[], false, true, 34)
  on conflict (id) do update set category = excluded.category, name = excluded.name,
    description = excluded.description, includes = excluded.includes,
    studio_only = excluded.studio_only, active = excluded.active, sort_order = excluded.sort_order;
insert into public.service_variants (template_id, id, label, duration_min, min_price, max_price, suggested_price, per_person, max_quantity, sort_order) values (
...
insert into public.service_variants (template_id, id, label, duration_min, min_price, max_price, suggested_price, per_person, max_quantity, sort_order) values (
  ...
  on conflict (template_id, id) do update set label = excluded.label, duration_min = excluded.duration_min,
    ...
    per_person = excluded.per_person, max_quantity = excluded.max_quantity, sort_order = excluded.sort_order;
insert into public.service_templates (id, category, name, description, includes, studio_only, active, sort_order) values (
  'photo-portrait', 'camera', 'Chụp chân dung máy ảnh', 'Chân dung, áo dài, kỷ yếu, concept cá nhân bằng máy ảnh.', array['Tư vấn concept & trang phục', 'Chụp máy ảnh', 'Ảnh chỉnh da, màu']::text[], false, true, 35)
  on conflict (id) do update set category = excluded.category, name = excluded.name,
    description = excluded.description, includes = excluded.includes,
    studio_only = excluded.studio_only, active = excluded.active, sort_order = excluded.sort_order;
insert into public.service_variants (template_id, id, label, duration_min, min_price, max_price, suggested_price, per_person, max_quantity, sort_order) values (
...
insert into public.service_variants (template_id, id, label, duration_min, min_price, max_price, suggested_price, per_person, max_quantity, sort_order) values (
  ...
  on conflict (template_id, id) do update set label = excluded.label, duration_min = excluded.duration_min,
    ...
    per_person = excluded.per_person, max_quantity = excluded.max_quantity, sort_order = excluded.sort_order;
insert into public.service_templates (id, category, name, description, includes, studio_only, active, sort_order) values (
  'photo-profile', 'camera', 'Ảnh hồ sơ / CV', 'Ảnh chân dung gọn gàng cho CV, LinkedIn, hồ sơ công ty.', array['Hướng dẫn tư thế', 'Chụp nền trơn hoặc văn phòng', 'Chỉnh da nhẹ']::text[], false, true, 36)
  on conflict (id) do update set category = excluded.category, name = excluded.name,
    description = excluded.description, includes = excluded.includes,
    studio_only = excluded.studio_only, active = excluded.active, sort_order = excluded.sort_order;
insert into public.service_variants (template_id, id, label, duration_min, min_price, max_price, suggested_price, per_person, max_quantity, sort_order) values (
...
insert into public.service_variants (template_id, id, label, duration_min, min_price, max_price, suggested_price, per_person, max_quantity, sort_order) values (
  ...
  on conflict (template_id, id) do update set label = excluded.label, duration_min = excluded.duration_min,
    ...
    per_person = excluded.per_person, max_quantity = excluded.max_quantity, sort_order = excluded.sort_order;
insert into public.service_templates (id, category, name, description, includes, studio_only, active, sort_order) values (
  'photo-event', 'camera', 'Chụp sự kiện nhỏ', 'Sinh nhật, tiệc công ty nhỏ, khai trương, lễ tốt nghiệp.', array['Chụp toàn bộ sự kiện', 'Ảnh gốc chọn lọc', 'Chỉnh màu']::text[], false, true, 37)
  on conflict (id) do update set category = excluded.category, name = excluded.name,
    description = excluded.description, includes = excluded.includes,
    studio_only = excluded.studio_only, active = excluded.active, sort_order = excluded.sort_order;
insert into public.service_variants (template_id, id, label, duration_min, min_price, max_price, suggested_price, per_person, max_quantity, sort_order) values (
...
insert into public.service_variants (template_id, id, label, duration_min, min_price, max_price, suggested_price, per_person, max_quantity, sort_order) values (
  ...
  on conflict (template_id, id) do update set label = excluded.label, duration_min = excluded.duration_min,
    ...
    per_person = excluded.per_person, max_quantity = excluded.max_quantity, sort_order = excluded.sort_order;
insert into public.service_templates (id, category, name, description, includes, studio_only, active, sort_order) values (
  'video-short', 'short-video', 'Quay & dựng clip ngắn', 'Clip 15–60 giây cho TikTok, Reels: quay, dựng, nhạc, phụ đề.', array['Gợi ý kịch bản ngắn', 'Quay bằng điện thoại/máy ảnh', 'Dựng, chèn nhạc, phụ đề']::text[], false, true, 38)
  on conflict (id) do update set category = excluded.category, name = excluded.name,
    description = excluded.description, includes = excluded.includes,
    studio_only = excluded.studio_only, active = excluded.active, sort_order = excluded.sort_order;
insert into public.service_variants (template_id, id, label, duration_min, min_price, max_price, suggested_price, per_person, max_quantity, sort_order) values (
...
insert into public.service_variants (template_id, id, label, duration_min, min_price, max_price, suggested_price, per_person, max_quantity, sort_order) values (
  ...
  on conflict (template_id, id) do update set label = excluded.label, duration_min = excluded.duration_min,
    ...
    per_person = excluded.per_person, max_quantity = excluded.max_quantity, sort_order = excluded.sort_order;
insert into public.service_templates (id, category, name, description, includes, studio_only, active, sort_order) values (
  'video-event', 'short-video', 'Quay hậu trường / sự kiện', 'Quay lại buổi tiệc, buổi chụp, sự kiện nhỏ và dựng thành clip.', array['Quay toàn buổi', 'Dựng 1 clip tổng hợp', 'Nhạc & chuyển cảnh']::text[], false, true, 39)
  on conflict (id) do update set category = excluded.category, name = excluded.name,
    description = excluded.description, includes = excluded.includes,
    studio_only = excluded.studio_only, active = excluded.active, sort_order = excluded.sort_order;
insert into public.service_variants (template_id, id, label, duration_min, min_price, max_price, suggested_price, per_person, max_quantity, sort_order) values (
...
insert into public.service_variants (template_id, id, label, duration_min, min_price, max_price, suggested_price, per_person, max_quantity, sort_order) values (
  ...
  on conflict (template_id, id) do update set label = excluded.label, duration_min = excluded.duration_min,
    ...
    per_person = excluded.per_person, max_quantity = excluded.max_quantity, sort_order = excluded.sort_order;
insert into public.service_templates (id, category, name, description, includes, studio_only, active, sort_order) values (
  'product-basic', 'product-photo', 'Chụp sản phẩm nền trơn', 'Ảnh sản phẩm nền trắng/nền màu cho sàn thương mại điện tử.', array['Setup nền & ánh sáng', '3 góc mỗi sản phẩm', 'Tách nền, chỉnh màu']::text[], false, true, 40)
  on conflict (id) do update set category = excluded.category, name = excluded.name,
    description = excluded.description, includes = excluded.includes,
    studio_only = excluded.studio_only, active = excluded.active, sort_order = excluded.sort_order;
insert into public.service_variants (template_id, id, label, duration_min, min_price, max_price, suggested_price, per_person, max_quantity, sort_order) values (
...
insert into public.service_variants (template_id, id, label, duration_min, min_price, max_price, suggested_price, per_person, max_quantity, sort_order) values (
  ...
  on conflict (template_id, id) do update set label = excluded.label, duration_min = excluded.duration_min,
    ...
    per_person = excluded.per_person, max_quantity = excluded.max_quantity, sort_order = excluded.sort_order;
insert into public.service_templates (id, category, name, description, includes, studio_only, active, sort_order) values (
  'product-lifestyle', 'product-photo', 'Chụp sản phẩm bối cảnh', 'Sản phẩm đặt trong bối cảnh sử dụng thật, hợp quảng cáo và fanpage.', array['Lên concept bối cảnh', 'Đạo cụ cơ bản', 'Chỉnh màu']::text[], false, true, 41)
  on conflict (id) do update set category = excluded.category, name = excluded.name,
    description = excluded.description, includes = excluded.includes,
    studio_only = excluded.studio_only, active = excluded.active, sort_order = excluded.sort_order;
insert into public.service_variants (template_id, id, label, duration_min, min_price, max_price, suggested_price, per_person, max_quantity, sort_order) values (
...
insert into public.service_variants (template_id, id, label, duration_min, min_price, max_price, suggested_price, per_person, max_quantity, sort_order) values (
  ...
  on conflict (template_id, id) do update set label = excluded.label, duration_min = excluded.duration_min,
    ...
    per_person = excluded.per_person, max_quantity = excluded.max_quantity, sort_order = excluded.sort_order;
insert into public.service_templates (id, category, name, description, includes, studio_only, active, sort_order) values (
  'product-video', 'product-photo', 'Quay clip sản phẩm', 'Clip ngắn giới thiệu sản phẩm cho TikTok Shop, Shopee Video.', array['Kịch bản ngắn theo sản phẩm', 'Quay & dựng dọc 9:16', 'Nhạc, phụ đề']::text[], false, true, 42)
  on conflict (id) do update set category = excluded.category, name = excluded.name,
    description = excluded.description, includes = excluded.includes,
    studio_only = excluded.studio_only, active = excluded.active, sort_order = excluded.sort_order;
insert into public.service_variants (template_id, id, label, duration_min, min_price, max_price, suggested_price, per_person, max_quantity, sort_order) values (
...
insert into public.service_variants (template_id, id, label, duration_min, min_price, max_price, suggested_price, per_person, max_quantity, sort_order) values (
  ...
  on conflict (template_id, id) do update set label = excluded.label, duration_min = excluded.duration_min,
    ...
    per_person = excluded.per_person, max_quantity = excluded.max_quantity, sort_order = excluded.sort_order;
insert into public.service_templates (id, category, name, description, includes, studio_only, active, sort_order) values (
  'model-lookbook', 'model-photo', 'Mẫu chụp lookbook', 'Mặc và tạo dáng cho bộ sưu tập thời trang, ảnh shop online.', array['Tạo dáng theo concept', 'Thay trang phục của shop', 'Không bao gồm makeup & người chụp']::text[], false, true, 43)
  on conflict (id) do update set category = excluded.category, name = excluded.name,
    description = excluded.description, includes = excluded.includes,
    studio_only = excluded.studio_only, active = excluded.active, sort_order = excluded.sort_order;
insert into public.service_variants (template_id, id, label, duration_min, min_price, max_price, suggested_price, per_person, max_quantity, sort_order) values (
...
insert into public.service_variants (template_id, id, label, duration_min, min_price, max_price, suggested_price, per_person, max_quantity, sort_order) values (
  ...
  on conflict (template_id, id) do update set label = excluded.label, duration_min = excluded.duration_min,
    ...
    per_person = excluded.per_person, max_quantity = excluded.max_quantity, sort_order = excluded.sort_order;
insert into public.service_templates (id, category, name, description, includes, studio_only, active, sort_order) values (
  'model-hand', 'model-photo', 'Mẫu tay / cầm sản phẩm', 'Mẫu tay cho nail, trang sức, mỹ phẩm, sản phẩm cầm tay.', array['Tay được chăm sóc sẵn', 'Tạo dáng tay theo góc máy']::text[], false, true, 44)
  on conflict (id) do update set category = excluded.category, name = excluded.name,
    description = excluded.description, includes = excluded.includes,
    studio_only = excluded.studio_only, active = excluded.active, sort_order = excluded.sort_order;
insert into public.service_variants (template_id, id, label, duration_min, min_price, max_price, suggested_price, per_person, max_quantity, sort_order) values (
...
insert into public.service_variants (template_id, id, label, duration_min, min_price, max_price, suggested_price, per_person, max_quantity, sort_order) values (
  ...
  on conflict (template_id, id) do update set label = excluded.label, duration_min = excluded.duration_min,
    ...
    per_person = excluded.per_person, max_quantity = excluded.max_quantity, sort_order = excluded.sort_order;
insert into public.service_templates (id, category, name, description, includes, studio_only, active, sort_order) values (
  'model-beauty', 'model-photo', 'Mẫu làm đẹp cho thương hiệu', 'Làm mẫu makeup, tóc, chăm sóc da cho thương hiệu hoặc lớp dạy nghề.', array['Làm mẫu theo yêu cầu', 'Tạo dáng khi chụp kết quả']::text[], false, true, 45)
  on conflict (id) do update set category = excluded.category, name = excluded.name,
    description = excluded.description, includes = excluded.includes,
    studio_only = excluded.studio_only, active = excluded.active, sort_order = excluded.sort_order;
insert into public.service_variants (template_id, id, label, duration_min, min_price, max_price, suggested_price, per_person, max_quantity, sort_order) values (
...
insert into public.service_variants (template_id, id, label, duration_min, min_price, max_price, suggested_price, per_person, max_quantity, sort_order) values (
  ...
  on conflict (template_id, id) do update set label = excluded.label, duration_min = excluded.duration_min,
    ...
    per_person = excluded.per_person, max_quantity = excluded.max_quantity, sort_order = excluded.sort_order;
insert into public.service_templates (id, category, name, description, includes, studio_only, active, sort_order) values (
  'model-clip', 'model-video', 'Diễn viên clip ngắn', 'Diễn clip TikTok, Reels, video giới thiệu sản phẩm theo kịch bản.', array['Diễn theo kịch bản', 'Nói/ lồng tiếng nếu cần']::text[], false, true, 46)
  on conflict (id) do update set category = excluded.category, name = excluded.name,
    description = excluded.description, includes = excluded.includes,
    studio_only = excluded.studio_only, active = excluded.active, sort_order = excluded.sort_order;
insert into public.service_variants (template_id, id, label, duration_min, min_price, max_price, suggested_price, per_person, max_quantity, sort_order) values (
...
insert into public.service_variants (template_id, id, label, duration_min, min_price, max_price, suggested_price, per_person, max_quantity, sort_order) values (
  ...
  on conflict (template_id, id) do update set label = excluded.label, duration_min = excluded.duration_min,
    ...
    per_person = excluded.per_person, max_quantity = excluded.max_quantity, sort_order = excluded.sort_order;
insert into public.service_templates (id, category, name, description, includes, studio_only, active, sort_order) values (
  'model-live', 'model-video', 'Mẫu livestream / mặc thử', 'Mặc thử, giới thiệu sản phẩm trong phiên livestream bán hàng.', array['Mặc thử & giới thiệu', 'Tương tác người xem theo kịch bản']::text[], false, true, 47)
  on conflict (id) do update set category = excluded.category, name = excluded.name,
    description = excluded.description, includes = excluded.includes,
    studio_only = excluded.studio_only, active = excluded.active, sort_order = excluded.sort_order;
insert into public.service_variants (template_id, id, label, duration_min, min_price, max_price, suggested_price, per_person, max_quantity, sort_order) values (
